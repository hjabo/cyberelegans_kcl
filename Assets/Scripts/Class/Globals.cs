...
public class Globals
{
    ...
    public static string NeuronConnFile =   Application.dataPath + ConfigPath + "celegans302connections.full.txt";
    //public static string NeuronConnFile =   Application.dataPath + ConfigPath + "C.Elegans_Neuronal_Network_Details_condensed.txt";
    public static string NeuronMuscleFile = Application.dataPath + ConfigPath + "neuromuscle.txt";
    //public static string NeuronMuscleFile = Application.dataPath + ConfigPath + "NeuronFixedPoints.txt";
    ...
    public const float GroundHeight = -0.3f;
    ...
    public const float MaxDelta = 0.004f;
